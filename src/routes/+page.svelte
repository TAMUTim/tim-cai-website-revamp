...
<div class="flex flex-col items-center justify-center font-ibm mt-10">
	<div class="w-content" style="--stagger: 1" data-animate>
		...
		<p class="mt-5 text-lg text-left text-slate-300">
			I make cool things with cool technologies, sometimes relating to Computer Networking. Creating
			stuff is my passion, and writing about it is too. Check out my writing <a href="/blog">here</a
			>, and my work <a href="/work">here</a>.
		</p>

		<p class="mt-5 text-lg text-left text-slate-300">
			Independent of programming, I like fitness, reading, and food. Recently, I've been enjoying
			the works of Haruki Murakami. I'm also doing a cool thing <a href="/project-summer">here</a>,
	...
	<div class="w-content" style="--stagger: 2" data-animate>
		...
		<p class="text-lg text-left text-slate-300">
			I am always open to new opportunities, if you are interested in offering me a job, please
			contact me at the email above, thank you.
		</p>
	</div>
</div>
