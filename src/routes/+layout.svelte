...
<nav class="font-ibm z-10 sticky top-0">
	<div class="mx-auto px-2 py-2 sm:px-6 lg:px-8">
		<div class="relative flex h-16 items-center justify-between">
			...
			<div
				class="nav-links font-nabla absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0"
			>
...
<button
	...
	class="fixed right-3 bottom-3 w-10 h-10 rounded-full z-100 print:hidden text-slate-200 {y > 10
		? 'opacity-100'
		: 'opacity-0'}"
